...
def paint():
    ...
    canvas.itemconfig(player,fill='blue',outline='black')
...
def hide(event):
    ...
    canvas.create_text(300,400,text='Вы выйграли!',font='Arial 20', fill='green')
...
canvas.create_text(300,400,
                   text='Чтобы выйграть, вам нужно дойти до кнопки "Финиш", управляя мышью\nСтарайтесь не задеть ни одного лазера',
